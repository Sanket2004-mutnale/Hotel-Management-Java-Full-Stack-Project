...
//    @PreAuthorize("hasAuthority('ADMIN')")
    ...
    public ResponseEntity<Response> getAvailableRooms() {
        Response response = roomService.getAllAvailable();
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
   ...
   // @PreAuthorize("hasAuthority('ADMIN')")
    ...
    public ResponseEntity<Response> deleteRoom(@PathVariable Long roomId) {
        Response response = roomService.deleteRoom(null);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
}
...
//			Response response = new Response();
//			response.setStatusCode(400);
//			response.setMessage("Please provide valuse for all fildes(photo,roomType,roomPrice)");
//			return ResponseEntity.status(response.getStatusCode()).body(response);
//		}
//		
//		Response response = roomService.addNewRoom(photo, roomType, roomPrice, roomDescription);
...
//			Response response = new Response();
//			response.setStatusCode(400);
//			response.setMessage("Please provide valuse for all fildes(checkInDate,checkOutDate,roomType)");
//			return ResponseEntity.status(response.getStatusCode()).body(response);
//		}
//		
//		Response response = roomService.getAvailableRoomsByDateAndType(checkInDate, checkOutDate, roomType);
